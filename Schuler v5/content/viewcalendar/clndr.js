...
(function (factory) {
    ...
    var clndrTemplate =
        ...
        //     "<div class='row'>" +
        //         "<div class='col-lg-12'>" +
        //             "<div class='clndr-control-button left'>" +
        //                 "<span class='clndr-previous-button btn btn-info'><i class='fa fa-chevron-left fa-2x'></i></span>" +
        //             "</div>" +
        //             "<div class='month center'><%= month %> <%= year %></div>" +
        //             "<div class='clndr-control-button rightalign right'>" +
        //                 "<span class='clndr-next-button btn btn-info'><i class='fa fa-chevron-right fa-2x'></i></span>" +
        //             "</div>" +
        //         "</div>" +
        //         "<div class='col-lg-12'>" +
        ...
        "<div class='clndr-controls'>" +
            // "<div class='clndr-control-button left'>" +
                "<span class='clndr-previous-button btn left'><i class='fa fa-chevron-left fa-2x'></i></span>" +
            // "</div>" +
            "<div class='month center'><%= month %> <%= year %></div>" +
            // "<div class='clndr-control-button rightalign right'>" +
                "<span class='clndr-next-button btn right'><i class='fa fa-chevron-right fa-2x'></i></span>" +
            // "</div>" +
        "</div>" +
        "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
            "<thead>" +
